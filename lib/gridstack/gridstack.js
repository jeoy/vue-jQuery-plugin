...
(function(factory) {
    ...
    GridStackEngine.prototype._fixCollisions = function(node) {
        console.log('into fixCollisions, 待解决冲突的节点是');
        console.log(node)
        var self = this;
        this._sortNodes(-1);
        var nn = node;
        ...
        while (true) {
            if (!this.isFixCollisionOn) {
                console.log('因为isFixCollisionOn === false 而return 不解决冲突')
                return;
            }
            if (!node.el) {
            ...
            if (typeof collisionNode === 'undefined') {
                console.log('因collisionNode不存在而return 不解决冲突')
                return;
            }
            console.log('解决冲突----移动节点:');
    ...
    GridStack.prototype._prepareElementsByNode = function(el, node) {
        ...
        var onEndMoving = function(event, ui) {
            ...
            self.grid.isFixCollisionOn = true;
            console.log(self.grid.currentNode);
            self.grid._fixCollisions(self.grid.currentNode);
